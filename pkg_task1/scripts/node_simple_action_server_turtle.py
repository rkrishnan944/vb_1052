...
from node_iot_action_client_turtle import *
...
class SimpleActionServerTurtle:
    ...
    def func_on_rx_goal(self, obj_msg_goal):
        rospy.loginfo("Received a Goal from Client.")       #ignore
        rospy.loginfo(obj_msg_goal)                         #ignore 
        ...
        self.func_rotate(obj_msg_goal.angle, '15', 'a')
        ...
        #action_client.send_data_to_mqtt("mqtt", "pub", action_client._config_mqtt_pub_topic, str("{0} {1} {2}".format(int(obj_msg_result.final_x), int(obj_msg_result.final_y), int(obj_msg_result.final_theta))))
        #print(obj_msg_result)
