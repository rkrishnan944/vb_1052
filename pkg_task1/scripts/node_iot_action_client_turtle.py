...
'''def sent_to_sheet(position):
    
            # defining our sheet name in the 'id' variable and the the column where we want to update the value
    parameters = {"id":"Sheet1", "turtle_x":position.final_x,"turtle_y":position.final_y,"turtle_theta":position.final_theta} 

    URL = "https://script.google.com/macros/s/AKfycbzu3cYmXbQUgWW9yR5rXtb-CpEZjbZn40_9y1Rlc-f_BS3AlDLS/exec"
...
class IotRosBridgeActionClient:
    ...
    def __init__(self):
        ...
        # Initialize Action Clientprocess
        ...
        self._ros_pub_topic = '/turtle1/cmd_vel'
        self._ros_sub_topic = '/turtle1/pose'
        self._result_topic = '/action_turtle/result'
    ...
    def send_data(self, msg):
        ...
        self.send_data_to_mqtt("mqtt", "pub", self._config_mqtt_pub_topic, str("{0}, {1}, {2}".format(int(msg.result.final_x), int(msg.result.final_y), int(msg.result.final_theta))))

        #print("mmmmmmmmmmmmmmmmmmmmmmmm aaaaaaaaaaaaaaaaaaa gggggggggggggggggggggggggggggggyyyyyyyyyyyyyyyyyyyyyyyyaaaaaaaaaaaaaaaaa")
        #print(msg.result.final_x,msg.result.final_y,msg.result.final_theta)
...
def main():
    ...
    rospy.Subscriber(simple_action_client._result_topic, msgTurtleResult, simple_action_client.send_data)
    #rospy.Subscriber("", Pose, function1)
