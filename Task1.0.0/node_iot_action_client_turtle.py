...
def trace_hexagon():
    ...
    goal_handle1 = action_client.send_goal(2, 0)
    action_client._goal_handles['1'] = goal_handle1
    rospy.sleep(5)

    goal_handle2 = action_client.send_goal(2, 60)
    action_client._goal_handles['2'] = goal_handle2
    rospy.sleep(5)

    goal_handle3 = action_client.send_goal(2, 60)
    action_client._goal_handles['3'] = goal_handle3
    rospy.sleep(5)

    goal_handle4 = action_client.send_goal(2, 60)
    action_client._goal_handles['4'] = goal_handle4
    rospy.sleep(5)

    goal_handle5 = action_client.send_goal(2, 60)
    action_client._goal_handles['5'] = goal_handle5
    rospy.sleep(5)

    goal_handle6 = action_client.send_goal(2, 60)
...
# Main
def main():
    rospy.init_node('node_iot_ros_bridge_saction_client')
